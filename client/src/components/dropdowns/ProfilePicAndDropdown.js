...
const ProfilePicAndDropdown = ({ profileDropdown, notifications }) => {
  ...
  return (
    <div
      className={navStyles.profileContainer}
    ...
    >
      <div style={{ position: 'relative' }}>
        ...
        />
        {notifications ? (
          <span className={navStyles.picNotificationNumber}>
            {notifications}
          </span>
        ) : (
          <></>
      ...
      <span
        className={
          navStyles.profileDropdownArrow +
          ' ' +
          (profileDropdown ? navStyles.active : navStyles.inactive)
        }
      >
        ⯆
      </span>
      <ProfileDropdown
        ...
        className={
          profileDropdown ? navStyles.dropdownContainer : navStyles.hidden
        }
      />
    </div>
  );
