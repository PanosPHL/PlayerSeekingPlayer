...
import {
  ...
  toggleSearchInstrumentDropdown,
  toggleSearchStyleDropdown,
} from '../../store/ui/navbar';
import { setErrors, clearErrors } from '../../store/errors';
import SearchInstruments from '../sections/Search/SearchInstruments';
import SearchStyles from '../sections/Search/SearchStyles';
...
const SearchDropdown = () => {
  ...
  const { instrumentDropdown, styleDropdown } = useSelector(
    (state) => state.ui.navbar.searchDropdown
  );
      ...
      <div className={navStyles.searchDropdownContainer}>
        ...
        >
          ...
          >
            ...
            <select
              className={navStyles.distanceDropdown}
          ...
          <div className={navStyles.searchInstrumentDropdownContainer}>
            <p onClick={toggleInstrumentDropdown}>
              <label className="labels">
                ...
                <span
                  className={
                    instrumentDropdown
                      ? navStyles.downInstrumentTriangle
                      : navStyles.rightInstrumentTriangle
                  }
                >
                  &#9654;
                </span>
            ...
            <SearchInstruments
              className={
                instrumentDropdown
                  ? navStyles.searchInstrumentDropdown
                  : navStyles.hiddenInstrumentDropdown
              }
          ...
          <div className={navStyles.searchStyleDropdownContainer}>
            <p onClick={toggleStyleDropdown}>
              <label className="labels">
                ...
                <span
                  className={
                    styleDropdown
                      ? navStyles.downStyleTriangle
                      : navStyles.rightStyleTriangle
                  }
                >
                  &#9654;
                </span>
            ...
            <SearchStyles
              className={
                styleDropdown
                  ? navStyles.searchStyleDropdown
                  : navStyles.hiddenStyleDropdown
              }
              labelStyle={navStyles.checkboxLabel}
            />
          </div>
