  ...
  return (
    <RecordingContext.Provider value={value}>
      <div
        ...
        className={
          (i === 1
            ? recordingStyles.firstRecording
            : recordingStyles.recordingContainer) +
      ...
      >
        <div className={recordingStyles.recordingHeaderContainer}>
          ...
          {isOwner ? (
            <button
              className={recordingStyles.editButton}
        ...
        <div className={recordingStyles.recordingContentContainer}>
          ...
          <div className={recordingStyles.recordingDescriptionContainer}>
            {description ? (
              <div>
                <h4 className={recordingStyles.aboutRecordingHeader}>
                  About this recording:
                </h4>
                <p className={recordingStyles.recordingDescription}>
                  {description}
                </p>
              </div>
            ) : (
