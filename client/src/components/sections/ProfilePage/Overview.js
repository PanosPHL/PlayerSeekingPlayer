...
import OverviewEditButton from '../../buttons/OverviewEditButton';
    ...
    <OverviewContext.Provider value={value}>
      ...
      <ul className={aboutStyles.overviewList}>
        ...
        <li>
          ...
          userProfile.profileInfo.location
            ? 'Lives in ' +
              userProfile.profileInfo.location.split(locationRegex)[0]
            : 'This user has not yet set a location'}
        </li>
