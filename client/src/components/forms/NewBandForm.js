    ...
    <form className={bandStyles.newBandForm} onSubmit={handleSubmit}>
      <div className={bandStyles.titleAndButtonContainer}>
        ...
        <button
          ...
          onClick={() => dispatch(toggleNewBandModal())}
        >
      ...
      {errors.length ? (
        <Errors
          ...
          divStyle={bandStyles.newBandFormErrors}
          errors={errors}
        />
      ) : (
        <></>
      ...
      <div className={bandStyles.newBandFormContent}>
        <div className={bandStyles.formControlGroup}>
          <p>
        ...
        <button className={bandStyles.submitButton} type="submit">
          Submit
        </button>
      </div>
    </form>
