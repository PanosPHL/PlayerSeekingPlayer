    ...
    return (
        <div className={bandStyles.bandFormMemberRow}>
                <div className={bandStyles.bandFormMemberRowPicAndInfo}>
                    <img className={bandStyles.bandFormMemberRowPic} src={member.profileInfo.profilePic || '/static/images/default_profile_photo.jpg'} alt={`${member.firstName} ${member.lastName}`}/>
                    <div>
